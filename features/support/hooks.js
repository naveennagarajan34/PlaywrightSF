...
BeforeAll(async function () {
  ...
  const email = "naveen.n+qa@ecgroup-intl.com";
  const password = "test@123";
  await page.goto("https://qa.scriptureforge.org/");
  await page.locator("div.login-buttons a.mdl-button--raised").click();
...
//   await page.goto("https://qa.scriptureforge.org/projects/");
//   if (page.locator("//app-my-projects").isVisible({ timeout: 15000 })) {
//     return;
//   } else {
